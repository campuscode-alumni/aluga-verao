...
feature 'Owner create property' do
  ...
  scenario 'successfully' do
    ...
    property = Property.create(title: 'AP Top', city: 'SaoPaulo', state: 'SP', property_type: property_type, description: 'sitio do meu vo', daily_rate: 90.0, photo: 'sitio.jpg',
  ...
  scenario 'and must fill owner' do
    ...
    property = Property.create( city: 'SaoPaulo', state: 'SP', property_type_id: property_type.id, description: 'sitio do meu vo', daily_rate: 90.0, photo: 'sitio.jpg',
  ...
  scenario 'and edit a property' do
    ...
    property = Property.create(title: 'sitio do meu vo', city: 'SaoPaulo', state: 'SP', property_type_id: property_type.id, description: 'sitio do meu vo muito bac',
                              daily_rate: 90, photo: 'sitio.jpg', maximum_guests: 5, minimun_rent: 2, maximum_rent: 3,
